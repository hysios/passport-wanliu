...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'http://localhost:8080/auth/wanliu_id/authorize';
  options.tokenURL = options.tokenURL || 'http://localhost:8080/auth/wanliu_id/access_token';
  options.scopeSeparator = options.scopeSeparator || ',';
  options.state = 'undefined' !== typeof options.state ? options.state : true;

  OAuth2Strategy.call(this, options, verify);
  this.name = 'wanliu';
  this._profileURL = options.profileURL || 'http://localhost:8080/auth/wanliu_id/user';
