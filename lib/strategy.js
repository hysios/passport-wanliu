...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'http://accounts.wanliu.biz/auth/wanliu_id/authorize';
  options.tokenURL = options.tokenURL || 'https://graph.wanliu.com/auth/wanliu_id/access_token';
  options.scopeSeparator = options.scopeSeparator || ',';

  OAuth2Strategy.call(this, options, verify);
  this.name = 'wanliu';
  this._profileURL = options.profileURL || 'https://graph.wanliu.com/auth/wanliu_id/user';
